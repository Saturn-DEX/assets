...
**Important:** Token address folders and `info.json` `address` must be lowercase (`0x` + 40 hex lowercase). EIP-55 checksumming is display-only. Submissions with non-lowercase addresses will be rejected.
